...
thymol.ready(function () {
	thymol.configurePreExecution( function() {
		var fred;
		var bx1 = new ThParam("Hello world!");
	    ...
	    thymol.applicationContext.createVariable("bxSet", ThSet.prototype.fromArray(bxArray) );    

		var bx2Array = [true,true,true,true];
	    thymol.applicationContext.createVariable("bx2Array", bx2Array );
	    thymol.applicationContext.createVariable("bx2Set", ThSet.prototype.fromArray(bx2Array) );    

		var bx3Array = [false,false,false,false];
	    thymol.applicationContext.createVariable("bx3Array", bx3Array );
	    thymol.applicationContext.createVariable("bx3Set", ThSet.prototype.fromArray(bx3Array) );    
	});
});