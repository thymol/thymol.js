...
var	thVars = [
   	       ...
   	       ["disco4", "#['AN1','J&apos;te fais un plan','L&apos;Album','Plastiquez vos baffles','Grands succ�s/Greatest Hits','Chat va...Et Toi?','Pix','Suite diagonale','Ultraterrestre','Dandy Bandit']" ],
   	       ["artist4", "#{'name' : 'Plastic Bertrand', 'firstname' : 'Roger', 'lastname' : 'Jouret', 'discography' : #disco4, 'bio' : 'Plastic Bertrand (born Roger Allen Fran�ois Jouret, 24 February 1954, Brussels[1]) is a Belgian musician, songwriter, producer, editor and television presenter, best known for the 1978 international hit single &quot;�a plane pour moi&quot;.'}" ],
